...
/**
 * @version V1.0
 * @title: VSmzcFunctionEntity
 * @projectName sdbst
 * @description: TODO
 * @author： 张恭雨
 * @date 2019/10/31 16:07
 */
@TableMapperAnnotation(tableName = "V_SMZC_FUNCTION", uniqueKeyType = UniqueKeyType.Single, uniqueKey = "ID")
@Data
public class VSmzcFunctionEntity extends BaseEntity {
